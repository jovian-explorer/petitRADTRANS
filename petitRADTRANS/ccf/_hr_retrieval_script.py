...
def main(sim_id=0):
    ...
    telluric_transmittance = \
        os.path.join(module_dir, 'andes', 'sky', 'transmission', 'transmission.dat')
    airmass = os.path.join(module_dir, 'metis', 'brogi_crires_test', 'air.npy')
    variable_throughput = os.path.join(module_dir, 'metis', 'brogi_crires_test')  # True # for random VT
